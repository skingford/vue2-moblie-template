 ...
 * @LastEditTime: 2021-10-28 14:29:07
-->
<template>
  <van-cell-group>
    <van-cell icon="setting-o" title="读文件" @click="testRead" />
    <van-cell icon="setting-o" title="写文件" />
    <van-cell icon="setting-o" title="分页读取文件内容" />
    <van-cell icon="setting-o" title="获取文件家下所有文件列表" />
  </van-cell-group>
</template>
<script lang="ts">
